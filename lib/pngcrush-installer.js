...
// Requires
  ...
  exports.getFileURL = function( isWin , isWin64 ){
    ...
    var base = "http://downloads.sourceforge.net/project/pmt";

    if( !!isWin ) {
      url = base + "/pngcrush-executables/" + version + "/pngcrush_" + version_underscored + "_w32.exe";
      if( !!isWin64 ){
        url = base + "/pngcrush-executables/" + version + "/pngcrush_" + version_underscored + "_w64.exe";
      }
    } else {
      url = base + "/pngcrush/" + version + "/pngcrush-" + version + ".tar.gz";
    }
