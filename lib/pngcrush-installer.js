...
(function( exports ){
  "use strict";
  var version = "1.7.67";
  var version_underscored = "1_7_67";
...
// Requires
  ...
  exports.getFileURL = function( isWin , isWin64 ){
    ...
    if( !!isWin ) {
      url = "http://downloads.sourceforge.net/project/pmt/pngcrush-executables/" + version + "/pngcrush_" + version_underscored + "_w32.exe";
      if( !!isWin64 ){
        url = "http://downloads.sourceforge.net/project/pmt/pngcrush-executables/" + version + "/pngcrush_" + version_underscored + "_w64.exe";
      }
    } else {
      url = "http://downloads.sourceforge.net/project/pmt/pngcrush/" + version + "/pngcrush-" + version + ".tar.gz";
    }
